...
//		System.setProperty("webdriver.chrome.driver", "C:\\UpSkillSoftware\\chromeDriver\\chromedriver.exe");
        ...
        ChromeOptions options = new ChromeOptions();		//initializing chrome options to pass certain arguments to do something
...
//		options.addArguments("--headless");					//headless execution hides the browser
